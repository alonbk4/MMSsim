...
export function createDefaultDesign(): Design {
  return {
    ...
    site: { ...DEFAULT_SITE },
    placements: [
      makePlacement('roof-catchment', 60, 2, 2),
      makePlacement('poly-tank', 5, 12, 3),
      makePlacement('solar-pv', 4, 2, 8),
      makePlacement('annual-beds', 40, 14, 10),
      makePlacement('compost-bays', 3, 4, 16),
      makePlacement('laying-hens', 6, 16, 18),
    ],
    overrides: {},
    customSystems: [],
  };
